...
export function SyncingBanner({ isSyncing }: { isSyncing: boolean }) {
    ...
    return (
        <div className="glass-bar fixed top-0 left-0 right-0 text-[var(--app-fg)] text-center py-2 text-sm font-medium z-50 flex items-center justify-center gap-2 border-b border-[var(--app-divider)]">
