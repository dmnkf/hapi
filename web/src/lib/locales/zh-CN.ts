export default {
  ...
  'session.activity.open': '活动',
  'session.activity.close': '关闭活动',
  'session.activity.title': '活动',
  'session.activity.empty': '已加载消息中暂无活动',
  'session.activity.approvals': '审批',
  'session.activity.active': '活跃工作',
  'session.activity.files': '涉及文件',
  'session.activity.recent': '最近工具',
  'session.activity.conversation': '会话',
  'session.activity.noApprovals': '暂无待审批项',
  'session.activity.noActive': '暂无活跃工作',
  'session.activity.noFiles': '已加载消息中暂无涉及文件',
  'session.activity.noRecent': '暂无最近工具',
  'session.activity.tapToJump': '点击跳转到线程',
  'session.activity.backgroundTasks': '{n} 个后台任务',
  'session.activity.backgroundTasksHint': '子代理工作仍在运行',
