            ...
            <CardContent className="p-6 space-y-6">
              <div className="space-y-2">
                ...
                <div className="bg-slate-950 text-slate-50 p-4 rounded-xl font-mono text-sm flex justify-between items-center border-2 border-slate-800">
                  <code>npx @dmnkf/hapi hub --relay</code>
                  <Button variant="ghost" size="icon" className="text-slate-400 hover:text-white hover:bg-slate-800" onClick={() => copyToClipboard("npx @dmnkf/hapi hub --relay", "hub")}>
              ...
              <div className="space-y-2">
                ...
                <div className="bg-slate-950 text-slate-50 p-4 rounded-xl font-mono text-sm flex justify-between items-center border-2 border-slate-800">
                  <code>npx @dmnkf/hapi</code>
                  <Button variant="ghost" size="icon" className="text-slate-400 hover:text-white hover:bg-slate-800" onClick={() => copyToClipboard("npx @dmnkf/hapi", "session")}>
